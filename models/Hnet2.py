...
class HNet(nn.Module):
    def __init__(self, colordim=6, nhf=64):
        ...
        self.up4 = nn.ConvTranspose2d(in_size, out_size, kernel_size=4, stride=2, padding=1)
        self.upsamp3 = DoubleConv(nhf * 8, nhf * 4, nhf * 2)
        self.u3 = nn.ConvTranspose2d(in_size, out_size, kernel_size=4, stride=2, padding=1)
        self.upsamp2 = DoubleConv(nhf * 4, nhf * 2, nhf)
        self.up2 = nn.ConvTranspose2d(in_size, out_size, kernel_size=4, stride=2, padding=1)
